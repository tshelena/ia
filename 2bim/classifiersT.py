...
# excluindo a coluna SkinThickness
data.pop('SkinThickness')

# excluindo as linhas onde na coluna Insulin, o valor é 0
indexNames = data[data['Insulin'] == 0].index
...
# avalia a precisão comparando o modelo criado yhat, com o conjunto de dados de teste y_test
